  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        Text(PortfolioRepository.heroBio, textAlign: TextAlign.center, style: AppFonts.bodySmall(color: const Color(0x60ffffff), size: isCompact ? 8 * fs : 10 * fs, height: 1.7)),
