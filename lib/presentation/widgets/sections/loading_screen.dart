...
class _LoadingScreenState extends State<LoadingScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _fadeInCtrl  = AnimationController(vsync: this, duration: const Duration(milliseconds: 900));
  ...
  @override
  void dispose() { _fadeInCtrl.dispose(); _fadeOutCtrl.dispose(); super.dispose(); }
        ...
        child: Scaffold(
          ...
          body: Center(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ScaleTransition(
                ...
                child: Text('안녕하세요',
                    style: TextStyle(
                      ...
                      fontSize: 96, color: c.warmWhite, fontWeight: FontWeight.w300,
                    )),
              ),
              ...
              Text('로딩 · loading', style: AppFonts.mono(size: 13, color: c.textMuted)),
            ]),
          ),
        ),
      ),
